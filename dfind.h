...
#define DFIND_VERSION "0.4-modular"
...
void df_print_entry (const struct dfind_filters *f,
                     const struct dfind_entry *e);
...
int df_live_build_table_ram (const struct dfind_filters *f,
                             struct dfind_table *out);

/* fs_ext.c */
int df_ext_fast_search (const struct dfind_mount_info *mi,
                        const struct dfind_filters *f,
                        const char *rel_target,
                        const char *display_root);

int df_ext_build_cache (const struct dfind_mount_info *mi,
                        const struct dfind_filters *f,
                        const char *rel_target,
                        const char *display_root,
                        FILE *out);

int df_ext_build_table_ram (const struct dfind_mount_info *mi,
                            const struct dfind_filters *f,
                            const char *rel_target,
                            const char *display_root,
                            struct dfind_table *out);
...
/* fs_ntfs.c */
int df_ntfs_fast_search (const struct dfind_mount_info *mi,
                         const struct dfind_filters *f,
                         const char *rel_target,
                         const char *display_root);

int df_ntfs_build_cache (const struct dfind_mount_info *mi,
                         const struct dfind_filters *f,
                         const char *rel_target,
                         const char *display_root,
                         FILE *out);

int df_ntfs_build_table_ram (const struct dfind_mount_info *mi,
                             const struct dfind_filters *f,
                             const char *rel_target,
                             const char *display_root,
                             struct dfind_table *out);
